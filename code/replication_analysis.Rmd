...
plot(df$cor_orig, df$cor_rep, col=cols[df$psums], pch=19, cex=2, xlim=c(0,1), ylim=c(-0.5, 1), main="Effect sizes colored by # P < 0.05 (out of 100 replicates)", xlab="Original Effect Size", ylab="Replication Effect Size")
abline(0,1)
